...
phasedmode:	 YES
familynames:     NO
#numthreads:	 16""" > par.PED.PACKEDPED
...
familynames:     NO
phasedmode:      YES
#numthreads:      16""" > par.PACKEDPED.PACKEDANCESTRYMAP
...
indivoutname:    ${base}.ind
phasedmode:      YES
#numthreads:      16""" > par.PACKEDANCESTRYMAP.ANCESTRYMAP
...
indivoutname:    ${base}.ind
phasedmode:      YES
#numthreads:      16""" > par.ANCESTRYMAP.EIGENSTRAT
